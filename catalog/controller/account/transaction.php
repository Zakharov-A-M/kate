...
class ControllerAccountTransaction extends Controller
{
    ...
    public function index()
    {
        ...
        $transactionTotal = $this->model_account_transaction->getTotalTransactions();
        $results = $this->model_account_transaction->getTransactions($filterData);
        ...
        $pagination->total = $transactionTotal;
        ...
        $data['results'] = sprintf(
            ...
            ($transactionTotal) ? (($page - 1) * 10) + 1 : 0,
            ((($page - 1) * 10) > ($transactionTotal - 10)) ? $transactionTotal : ((($page - 1) * 10) + 10),
            $transactionTotal, ceil($transactionTotal / 10)
        );
