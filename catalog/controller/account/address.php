...
class ControllerAccountAddress extends Controller
{
    ...
    protected function getForm()
    {
        ...
        $data['text_address'] = !isset($this->request->get['address_id']) ?
            $this->language->get('text_address_add') :
        ...
        if (isset($this->request->get['address_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $addressInfo = $this->model_account_address->getAddress($this->request->get['address_id']);
        }

        if (isset($this->request->post['firstname'])) {
            $data['firstname'] = $this->request->post['firstname'];
        } elseif (!empty($addressInfo)) {
            $data['firstname'] = $addressInfo['firstname'];
        } else {
            $data['firstname'] = '';
        }
        ...
        if (isset($this->request->post['lastname'])) {
            ...
            $data['lastname'] = $addressInfo['lastname'];
        } else {
            $data['lastname'] = '';
        }
        ...
        if (isset($this->request->post['company'])) {
            ...
            $data['company'] = $addressInfo['company'];
        } else {
            $data['company'] = '';
        }
        ...
        if (isset($this->request->post['address_1'])) {
            ...
            $data['address_1'] = $addressInfo['address_1'];
        } else {
            $data['address_1'] = '';
        }
        ...
        if (isset($this->request->post['address_2'])) {
            ...
            $data['address_2'] = $addressInfo['address_2'];
        } else {
            $data['address_2'] = '';
        }
        ...
        if (isset($this->request->post['country_id'])) {
            ...
            $data['country_id'] = $addressInfo['country_id'];
        } else {
        ...
        if (isset($this->request->post['zone_id'])) {
            ...
            $data['zone_id'] = $addressInfo['zone_id'];
        } else {
            $data['zone_id'] = '';
        }
        ...
        } elseif (isset($addressInfo)) {
            $data['address_custom_field'] = $addressInfo['custom_field'];
        } else {
