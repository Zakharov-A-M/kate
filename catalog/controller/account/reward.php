...
class ControllerAccountReward extends Controller
{
    ...
    public function index()
    {
        ...
        $rewardTotal = $this->model_account_reward->getTotalRewards();
        $results = $this->model_account_reward->getRewards($filterData);
        ...
        $data['results'] = sprintf(
            ...
            ($rewardTotal) ? (($page - 1) * 10) + 1 : 0,
            ((($page - 1) * 10) > ($rewardTotal - 10)) ? $rewardTotal : ((($page - 1) * 10) + 10),
            $rewardTotal, ceil($rewardTotal / 10)
        );
