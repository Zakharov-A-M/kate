	...
	public function add() {
		...
		if ($product_info) {
			if (!in_array($this->request->post['product_id'], $this->session->data['compare'])) {
                ...
                $json['danger'] = sprintf($this->language->get('text_danger'), $this->url->link('product/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('product/compare'));
            }
		}
