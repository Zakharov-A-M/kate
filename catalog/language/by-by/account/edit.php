...
$_['error_patronymic']   = 'Отчество должна быть от 1 до 32 символов!';
$_['error_email']        = 'E-Mail адрес введен неверно!';
$_['error_telephone']    = 'Номер телефона должен быть от 3 до 32 символов!';
$_['error_custom_field'] = 'Поле "%s" не может быть пустым!';
$_['error_validate_date'] = 'Поле "%s" неверно указано!';
