...
// Text
$_['text_success']     = '<div class="eOneTile_buttonWrap inline js_ib">
                            <span>
                                <a href="%s">
                                    <button type="button" class="bFlatButton btn mTitle mAddToCart mActive mHoverText">Оформить</button>
                                </a>
                            </span>
                          </div>';
...
$_['text_delete_product']   = ' Вы уверены, что хотите удалить данный элемент?';
$_['text_cancel']           = 'Отменить';
$_['text_success_delete']   = 'Удалить';
$_['text_amount']           = 'Наличие';
