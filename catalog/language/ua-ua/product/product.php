...
// Text
$_['text_search']                             = 'Пошук';
$_['text_size']                               = 'Розмір (dxDxh):';
$_['text_weight']                             = 'Вага, кг';
$_['text_scope']                              = 'Об `єм: ';
$_['text_length']                             = 'Довжина:';
$_['text_notation']                           = 'Позначення:';
$_['text_brand']                              = 'Бренд';
...
$_['text_success']                            = 'Дякую за ваш відгук. Він поступив адміністратору для перевірки на спам і незабаром буде опублікований.';
...
$_['text_payment_until_canceled_description'] = 'Сума: %s; Періодичність:  %d %s ; Кількість платежів: до відміни';
$_['text_day']                                = 'день';
$_['text_week']                               = 'тижня';
$_['text_semi_month']                         = 'півмісяця';
$_['text_month']                              = 'місяць';
$_['text_year']                               = 'рік';
$_['text_analog']                             = 'АНАЛОГИ';
$_['text_cart']                               = 'В корзину';
$_['text_product_related']                    = 'З ЦИМ ТОВАРОМ ЧАСТО КУПЛЯЮТЬ';
$_['text_in_cart_quantity_product']           = 'В кошику %s шт.';
$_['text_in_cart_link']                       = 'Перейти';
$_['text_in_cart']                            = 'В кошику';
$_['text_in_checkout']                        = 'Оформити';
$_['text_count']                              = 'шт.';
