...
$_['text_success']      = 'Товар <a href="%s">%s</a> додано до вашого <a href="%s">списку порівняння</a>!';
$_['text_remove']       = 'Видалено зі списку порівнянна';
$_['text_empty']        = 'Ви не обрали ні одного товару для порівнянн.';
$_['text_danger']       = 'Товар <a href="%s">%s</a> вже додано до  <a href="%s">порівняння товарів</a>!';
