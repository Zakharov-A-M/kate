...
$_['text_transaction_outstanding_payment'] = 'Невдалий платіж';
...
$_['text_transaction_suspended_failed'] = 'Заморожений через помилку в оплаті';
$_['text_transaction_outstanding_failed'] = 'Несплачений через помилку в оплаті';
...
// Column
$_['column_date_added'] = 'Створений';
$_['column_type'] = 'Тип';
$_['column_amount'] = 'Разом';
$_['column_status'] = 'Статус';
$_['column_product'] = 'Товар';
$_['column_action'] = 'Дія';
$_['column_recurring_id'] = 'ID Профіля';

// Error
$_['error_not_cancelled'] = 'Помилка: %s';
$_['error_not_found']     = 'Неможна відключити профіль';
