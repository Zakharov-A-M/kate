	...
	public function __construct($registry) {
		...
		if (isset($this->session->data['customer_id'])) {
			...
			if ($customer_query->num_rows) {
				...
				$this->partner_guid = $customer_query->row['partner_guid'];
				$this->registred = $customer_query->row['registred'];
				$this->GUID = $customer_query->row['GUID'];
				$this->patronymic = $customer_query->row['patronymic'];
				$this->address = json_decode($customer_query->row['custom_field'], true)[15] ?? '';
