...
class ModelCatalogNews extends Model {
    ...
    {
		$query = $this->db->query("SELECT DISTINCT *, (SELECT keyword FROM " . DB_PREFIX . "seo_url WHERE query = 'news_id=" . (int)$news_id . "') AS keyword FROM " . DB_PREFIX . "news n LEFT JOIN " . DB_PREFIX . "news_description nd ON (n.news_id = nd.news_id) WHERE n.news_id = '" . (int)$news_id . "' AND nd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
    ...
    {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE query = 'information/news'");
		if ($query) {
			$this->db->query("DELETE FROM " . DB_PREFIX . "seo_url WHERE query = 'information/news'");
			$this->db->query("INSERT INTO `" . DB_PREFIX . "seo_url` SET `query` = 'information/news', `keyword` = '" . $this->db->escape($url) . "'");
		}else{
			$this->db->query("INSERT INTO `" . DB_PREFIX . "seo_url` SET `query` = 'information/news', `keyword` = '" . $this->db->escape($url) . "'");
		}
	}
