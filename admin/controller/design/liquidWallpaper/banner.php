...
class ControllerDesignLiquidWallpaperBanner extends Controller
{
	private $error = [];
	private $countries = [];
    ...
    {
		$this->load->language('design/liquidWallpaper/banner');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $this->model_setting_setting->editSettingValue(
                'config_banner_liquid_wallpaper',
                'config_banner_liquid_wallpaper',
                $data
            );
	...
	protected function getForm()
    {
		...
		$banner_info = $this->config->get('config_banner_liquid_wallpaper');
		...
		$this->response->setOutput($this->load->view('design/liquidWallpaper/banner_form', $data));
	}
