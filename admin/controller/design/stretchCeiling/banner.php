...
class ControllerDesignStretchCeilingBanner extends Controller
{
	private $error = [];
	private $countries = [];
    ...
    {
		$this->load->language('design/stretchCeiling/banner');
	...
	protected function getForm()
    {
		...
		$banner_info = $this->config->get('config_banner_stretch_ceiling');
		...
		$this->response->setOutput($this->load->view('design/stretchCeiling/banner_form', $data));
	}
