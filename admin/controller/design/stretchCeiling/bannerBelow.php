...
class ControllerDesignStretchCeilingBannerBelow extends Controller
{
	private $error = [];
	private $countries = [];
    ...
    {
		$this->load->language('design/stretchCeiling/bannerBelow');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $this->model_setting_setting->editSettingValue(
                'config_banner_stretch_ceiling_below',
                'config_banner_stretch_ceiling_below',
                $data
            );
	...
	protected function getForm()
    {
		...
		$banner_info = $this->config->get('config_banner_stretch_ceiling_below');
		...
		$this->response->setOutput($this->load->view('design/stretchCeiling/banner_form_below', $data));
	}
