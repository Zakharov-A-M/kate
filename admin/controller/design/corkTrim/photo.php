...
class ControllerDesignCorkTrimPhoto extends Controller
{
	private $error = [];
	private $countries = [];
    ...
    {
		$this->load->language('design/corkTrim/photo');
	...
	protected function getForm()
    {
		...
		$banner_info = $this->config->get('config_photo_cork_trim');
		...
		$this->response->setOutput($this->load->view('design/corkTrim/photo_form', $data));
	}
