...
class ControllerDesignCorkTrimBanner extends Controller
{
	private $error = [];
	private $countries = [];
    ...
    {
		$this->load->language('design/corkTrim/banner');
	...
	protected function getForm()
    {
        ...
        $data['breadcrumbs'][] = [
            'text' => $this->language->get('text_corkTrim_page'),
        ];
		...
		$banner_info = $this->config->get('config_banner_cork_trim');
		...
		$this->response->setOutput($this->load->view('design/corkTrim/banner_form', $data));
	}
