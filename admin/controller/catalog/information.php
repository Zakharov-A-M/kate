...
class ControllerCatalogInformation extends Controller
{
    ...
    protected function getList()
    {
        ...
        foreach ($results as $result) {
            $data['informations'][] = [
                ...
                'edit' => $this->url->link(
                    ...
                    'user_token=' . $this->session->data['user_token'] .
                    '&information_id=' . $result['information_id'] . $url
                )
            ];
        }
        ...
        $data['sort_title'] = $this->url->link(
            'catalog/information',
            'user_token=' . $this->session->data['user_token'] . '&sort=id.title' . $url
        );
        $data['sort_sort_order'] = $this->url->link(
            'catalog/information',
            'user_token=' . $this->session->data['user_token'] . '&sort=i.sort_order' . $url
        );
        ...
        $data['results'] = sprintf(
            ...
            ($information_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0,
            (
                (($page - 1) * $this->config->get('config_limit_admin')) >
                ($information_total - $this->config->get('config_limit_admin'))
            ) ? $information_total : (
                (($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')),
            $information_total,
            ceil($information_total / $this->config->get('config_limit_admin'))
        );
    ...
    protected function getForm()
    {
        ...
        $data['text_form'] = !isset($this->request->get['information_id']) ?
        ...
        if (!isset($this->request->get['information_id'])) {
            ...
            $data['action'] = $this->url->link(
                'catalog/information/edit',
                'user_token=' . $this->session->data['user_token'] .
                '&information_id=' . $this->request->get['information_id'] . $url
            );
        }
        ...
        if (isset($this->request->post['information_description'])) {
            ...
            $data['information_description'] = $this->model_catalog_information->getInformationDescriptions(
        ...
        if (isset($this->request->post['information_store'])) {
            ...
            $data['information_store'] = $this->model_catalog_information->getInformationStores(
                $this->request->get['information_id']
            );
        } else {
        ...
        if (isset($this->request->post['is_visible'])) {
            $data['is_visible'] = $this->request->post['is_visible'];
        } elseif (!empty($information_info)) {
            $data['is_visible'] = $information_info['is_visible'];
        } else {
            $data['is_visible'] = 0;
        }
        ...
        if (isset($this->request->post['information_seo_url'])) {
            ...
            $data['information_seo_url'] = $this->model_catalog_information->getInformationSeoUrls(
                $this->request->get['information_id']
            );
        } else {
        ...
        if (isset($this->request->post['information_layout'])) {
            ...
            $data['information_layout'] = $this->model_catalog_information->getInformationLayouts(
                $this->request->get['information_id']
            );
        } else {
    ...
    protected function validateForm()
    {
        ...
        foreach ($this->request->post['information_description'] as $language_id => $value) {
            ...
            if ((utf8_strlen($value['meta_title']) < 1) || (utf8_strlen($value['meta_title']) > 500)) {
                        ...
                        foreach ($seo_urls as $seo_url) {
                            if (($seo_url['store_id'] == $store_id) &&
                                (
                                    ...
                                    ($seo_url['query'] != 'information_id=' . $this->request->get['information_id'])
                                )
                            ) {
