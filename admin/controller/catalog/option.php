    ...
    protected function getList()
    {
        ...
        foreach ($results as $result) {
            $data['options'][] = [
                ...
                'edit' => $this->url->link(
                    'catalog/option/edit',
                    'user_token=' . $this->session->data['user_token'] . '&option_id=' . $result['option_id'] . $url
                )
            ];
        }
        ...
        $data['results'] = sprintf(
            ...
            ($option_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0,
            (
                (($page - 1) * $this->config->get('config_limit_admin')) >
                ($option_total - $this->config->get('config_limit_admin'))
            ) ? $option_total : (
    ...
    protected function getForm()
    {
        ...
        if (!isset($this->request->get['option_id'])) {
            ...
            $data['action'] = $this->url->link(
                'catalog/option/edit',
                'user_token=' . $this->session->data['user_token'] .
                '&option_id=' . $this->request->get['option_id'] . $url
            );
        }
        ...
        if (isset($this->request->post['option_description'])) {
            ...
            $data['option_description'] = $this->model_catalog_option->getOptionDescriptions(
