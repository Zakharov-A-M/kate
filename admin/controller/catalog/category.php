...
class ControllerCatalogCategory extends Controller
{
    ...
    protected function getList()
    {
        ...
        $results = $this->model_catalog_category->getCategories($filterData);
        ...
        foreach ($results as $result) {
            $data['categories'][] = [
                ...
                'edit' => $this->url->link(
                    ...
                    'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url
                ),
        ...
        $data['results'] = sprintf(
            ...
            ($category_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0,
            (
    ...
    protected function getForm()
    {
        ...
        $data['text_form'] = !isset($this->request->get['category_id']) ?
        ...
        if (isset($this->request->post['category_description'])) {
            ...
            $data['category_description'] = $this->model_catalog_category->getCategoryDescriptions(
        ...
        if (isset($this->request->post['category_seo_url'])) {
            ...
            $data['category_seo_url'] = $this->model_catalog_category->getCategorySeoUrls(
                $this->request->get['category_id']
            );
        } else {
        ...
        if (isset($this->request->post['category_layout'])) {
            ...
            $data['category_layout'] = $this->model_catalog_category->getCategoryLayouts(
                $this->request->get['category_id']
            );
        } else {
                        ...
                        foreach ($seo_urls as $seo_url) {
                            if (($seo_url['store_id'] == $store_id) &&
                                (!isset($this->request->get['category_id']) ||
                                    ($seo_url['query'] != 'category_id=' . $this->request->get['category_id']))) {
