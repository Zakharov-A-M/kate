...
class ControllerCatalogFilter extends Controller
{
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect(
                $this->url->link('catalog/filter', 'user_token=' . $this->session->data['user_token'] . $url)
            );
        }
    ...
    protected function getList()
    {
        ...
        foreach ($results as $result) {
            $data['filters'][] = [
                ...
                'edit' => $this->url->link(
                    ...
                    '&filter_group_id=' . $result['filter_group_id'] . $url
                )
            ];
        }
        ...
        $data['sort_name'] = $this->url->link(
            'catalog/filter',
            'user_token=' . $this->session->data['user_token'] . '&sort=fgd.name' . $url
        );
        $data['sort_sort_order'] = $this->url->link(
            'catalog/filter',
            'user_token=' . $this->session->data['user_token'] . '&sort=fg.sort_order' . $url
        );
        ...
        $data['results'] = sprintf(
            ...
            (
                ...
                ($filter_total - $this->config->get('config_limit_admin'))
            ) ? $filter_total : (
    ...
    {
        $data['text_form'] = !isset($this->request->get['filter_id']) ?
        ...
        if (!isset($this->request->get['filter_group_id'])) {
            ...
            $data['action'] = $this->url->link(
                'catalog/filter/edit',
                'user_token=' . $this->session->data['user_token'] .
                '&filter_group_id=' . $this->request->get['filter_group_id'] . $url
            );
        }
        ...
        if (isset($this->request->post['filter_group_description'])) {
            ...
            $data['filter_group_description'] = $this->model_catalog_filter->getFilterGroupDescriptions(
        ...
        if (isset($this->request->post['filter'])) {
            ...
            $data['filters'] = $this->model_catalog_filter->getFilterDescriptions(
                $this->request->get['filter_group_id']
            );
        } else {
            $data['filters'] = [];
