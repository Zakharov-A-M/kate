...
class ControllerCatalogManufacturer extends Controller
{
    ...
    protected function getList()
    {
        ...
        foreach ($results as $result) {
            $data['manufacturers'][] = array(
                ...
                'edit' => $this->url->link(
                    ...
                    'user_token=' . $this->session->data['user_token'] .
                    '&manufacturer_id=' . $result['manufacturer_id'] . $url
                )
            );
        }
        ...
        $data['sort_sort_order'] = $this->url->link(
            'catalog/manufacturer',
            'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url
        );
        ...
        $data['results'] = sprintf(
            ...
            ($manufacturer_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0,
            (
                (($page - 1) * $this->config->get('config_limit_admin')) >
                ($manufacturer_total - $this->config->get('config_limit_admin'))
            ) ? $manufacturer_total : (
                (($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')),
            $manufacturer_total,
            ceil($manufacturer_total / $this->config->get('config_limit_admin'))
        );
    ...
    {
        $data['text_form'] = !isset($this->request->get['manufacturer_id']) ?
        ...
        if (isset($this->request->post['manufacturer_store'])) {
            ...
            $data['manufacturer_store'] = $this->model_catalog_manufacturer->getManufacturerStores(
                $this->request->get['manufacturer_id']
            );
        } else {
        ...
        if (isset($this->request->post['manufacturer_seo_url'])) {
            ...
            $data['manufacturer_seo_url'] = $this->model_catalog_manufacturer->getManufacturerSeoUrls(
                $this->request->get['manufacturer_id']
            );
        } else {
    ...
    protected function validateDelete()
    {
        ...
        foreach ($this->request->post['selected'] as $manufacturer_id) {
            $productTotal = $this->model_catalog_product->getTotalProductsByManufacturerId($manufacturer_id);
    ...
    public function autocomplete()
    {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            $results = $this->model_catalog_manufacturer->getManufacturers($filterData);
