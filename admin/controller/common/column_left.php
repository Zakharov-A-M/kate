...
class ControllerCommonColumnLeft extends Controller
{
	...
	public function index()
    {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ((string)$this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'domain/domain')) {
                $domain[] = array(
                    'name'	   => $this->language->get('text_domain'),
                    'href'     => $this->url->link('domain/domain', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($mainPageCatalog) {
                $design[] = [
                    'id'       => 'menu-main-page-category',
                    'icon'	   => 'fa-television',
                    'name'	   => $this->language->get('text_main_page_catalog'),
                    'href'     => '',
